...
<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
    ...
    <ul class="nav navbar-nav">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="summary.php">Transactions Summary<span class="sr-only">(current)
                </span></a></li>
...
<div class="container">
    <div class="row">
      <error>Oops! This Page is under Development Please Try Again Later.</error>
    </div>
</div>
</body>
</html>